	...
	<div class="container">
		...
		<div class="w3-agileits-about-grids">
			...
			<div class="col-md-7 agile-about-left">
				...
				<h3 class="w3l-sub">Eng ko'p takliflar</h3>
				<p class="sub-p">raqobatbardosh stavkalar va to'lovlar</p>
				<p class="sub-p2">Bank Locker</p>
			...
			<div class="col-md-6 col-sm-6 contact-left-w3ls">
				...
				<div class="visit">
					...
					<div class="col-md-10 col-sm-10 col-xs-10 contact-text-agileinf0">
						<h4>Visit us</h4>
						<p>Yangi Hayot tumani, Sergeli 7 A mavzesi</p>
					</div>
					<div class="clearfix"></div>
				</div>
				<div class="mail-w3">
					...
					<div class="col-md-10 col-sm-10 col-xs-10 contact-text-agileinf0">
						<h4>Mail us</h4>
						<p><a href="mailto:info@example.com">adiyorbek@gmail.com</a></p>
					</div>
					<div class="clearfix"></div>
				</div>
				<div class="call">
